...
<div class="col-md-12 mt-5 pt-3 border-bottom">
	<div class="text-dark px-0" >
		<p class="mb-1"><a href="{{route('admin.dashboard')}}"><i class="fa fa-home"></i> Dashboard / </a><a href="{{route('admin.salesList')}}">Sales /</a><a href="{{route('admin.purchaseAdd')}}" class="active-slink">Sales return</a> <span class="top-date">{{date('l, jS F Y')}}</span></p>
...
<div class="container-fluid p-3">
	<div class="box">
		<div class="box-header">
			...
			<h2 class="blue task-label">Sales Return</h2>
					...
					<!-- <form method="post" action="{{route('admin.sales.MakeSale')}}">
								...
								<tbody>
									...
									<tr>
										...
										<td class="p-2">{{$product->name}} <i class="fa fa-edit update-product" data-proid="{{$product->id}}"
											...
											<td style="text-align: center;">
												<a href="{{route('admin.sales.salesReturn.removeItem',$product->rowId)}}"><i class="fa fa-times-circle" title="Remove Item"></i></a>
											</td>
										</tr>
						...
						<div class="paymentBox">
							<div class="form-row p-3" style="background-color: #aaaaaa45;">
								...
								<div class="form-group col-6" id="chequeNumber">
									<label>Cheque Number</label>
									<input type="text" id="cheque_number" name="cheque_number" class="form-control">

								</div>
								<div class="form-group col-6" id="bank_name">
