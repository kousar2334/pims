    ...
    <div class="col-md-12 mt-5 pt-3 border-bottom">
        <div class="text-dark px-0">
            <p class="mb-1"><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i> Dashboard /
                </a><a href="" class="active-slink">System Setting</a><span
                    class="top-date">{{ date('l, jS F Y') }}</span></p>
                        ...
                        <form action="{{ route('admin.system.updateSystem') }}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="siteEmail"
                                        value="{{ $systemInfo->siteEmail }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Site Phone *</label>
                                    <input type="text" class="form-control" name="sitePhone"
                                        value="{{ $systemInfo->sitePhone }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Site Mobile *</label>
                                    <input type="text" class="form-control" name="mobile"
                                        value="{{ $systemInfo->mobile }}">
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Address *</label>
                                    <textarea name="address" class="form-control" rows="3">{{ $systemInfo->address }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="unitCode"
                                        value="{{ $systemInfo->unitCode }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Brand Code *</label>
                                    <input type="text" class="form-control" name="brandCode"
                                        value="{{ $systemInfo->brandCode }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Category Code *</label>
                                    <input type="text" class="form-control" name="categoryCode"
                                        value="{{ $systemInfo->categoryCode }}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label>Expense Category *</label>
                                    <input type="text" class="form-control" name="expenseCategoryUnit"
                                        value="{{ $systemInfo->expenseCategoryUnit }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Product Code *</label>
                                    <input type="text" class="form-control" name="productCode"
                                        value="{{ $systemInfo->productCode }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Invoice Code *</label>
                                    <input type="text" class="form-control" name="invoiceCode"
                                        value="{{ $systemInfo->invoiceCode }}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="purchaseCode"
                                        value="{{ $systemInfo->purchaseCode }}">
                                </div>

                                <div class="form-group col-md-4">
                                    <label>Sub Category Code *</label>
                                    <input type="text" class="form-control" name="subCategoryCode"
                                        value="{{ $systemInfo->subCategoryCode }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Store Code *</label>
                                    <input type="text" class="form-control" name="storeCode"
                                        value="{{ $systemInfo->storeCode }}">
                                </div>
                            </div>
