...
@section('posContent')
            ...
            <div id="left-top" class="mt-2">
                    ...
                    <div class="input-group" style="z-index:1;">
                        @if (Session::has('customer'))
                            <select class="form-control pos-input-tip" name="customer" value="" id="poscustomer">
                                <option value="{{ Session::get('customer') }}">{{ Session::get('customerName') }}
                                </option>
                        ...
                        <div class="input-group-addon no-print customer_btn">
                            <a href="#"><i class="fa fa-plus-circle" id="addIcon" data-toggle="modal"
                                    data-target=".customer_modal" title="Add new Customer"></i></a>
                        </div>

                        <div class="input-group-addon no-print customer_btn">
                            <a href="#" class="view_customer"><i class="fa fa-eye" id="addIcon" data-toggle="modal"
                                    data-target=".customer_details_modal" title="Customer Details"></i></a>
                        </div>
                ...
                <div class="no-print">
                    <div class="form-group" id="ui">
                        <div class="input-group" style="z-index:1;">
                            <input type="text" name="customer" value="" id="posProduct" required="required"
                                class="form-control pos-input-tip barcode" placeholder="Scan/search product name/code"
                                title="Scan/Search product name/code" />

                            <div class="input-group-addon no-print product_btn">
                                <a href="#" id="view-customer"><i class="fa fa-plus-circle" id="addIcon" data-toggle="modal"
                                        data-target=".product_modal" title="Add new Product"></i></a>
                            </div>
                            ...
                            <thead class="blue-table-head">
                                <tr>
                                    ...
                                    <th style="width: 5%; text-align: center;"><a
                                            href="{{ route('admin.pos.removeAllItem') }}" style="color:white;"
                                            title="Clear Cart"><i class="fa fa-trash"></i></a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @foreach (Cart::content() as $product)
                                    ...
                                    ?>
                                    <tr>
                                        <td width="40%">{{ $product->name }} <i class="fa fa-edit update-product"
                                                data-proid="{{ $product->id }}" data-row="{{ $product->rowId }}"
                                                style="cursor:pointer;color:#007bff;"></i></td>
                                        <td width="15%" style="text-align: right;">{{ number_format($product->price) }}
                                        </td>
                                        <td width="15%"><input type="text" value="{{ $product->qty }}"
                                                style="width: 100%;" class="qty_update_input"
                                                data-qty="{{ $product->rowId }}"></td>
                                        <td width="20%" style="text-align: right;">
                                            {{ number_format($product->subtotal) }}
                                        </td>
                                        <td style="width: 5%; text-align: center;"><a href="#"
                                                title="Remove {{ $product->name }}"
                                                data-cartrowrd="{{ $product->rowId }}" class="removeItemBtn"><i
                ...
                <div id="left-bottom">
                    <table id="totalTable" style="width:100%; float:right; padding:5px; color:#000; background: #FFF;">
                        <tr>
                            ...
                            <td class="text-right"
                                style="padding: 5px 10px;font-size: 14px;font-weight:bold;border-top: 1px solid #DDD;"><span
                                    id="total">{{ Cart::subtotal() }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 5px 10px;">VAT <a href="#" id="pptax2"><i class="fa fa-edit"
                                        data-toggle="modal" data-target=".tax_modal"></i></a>
                            </td>
                            <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;"><span
                                    id="ttax2">{{ Cart::tax() }}</span>
                            </td>
                            <td style="padding: 5px 10px;">Discount <a href="#" id="ppdiscount"><i class="fa fa-edit"
                                        data-toggle="modal" data-target=".discount_modal"></i></a>
                            </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-md-4" style="padding: 0;">
                                <div class="btn-group-vertical btn-block">
                                    <a href="{{ route('admin.pos.removeAllItem') }}"
                                        class="btn btn-danger btn-block btn-flat" style=";border-radius: 0px;"> Cancel</a>
                                </div>
                            </div>
                            <div class="col-xs-4 col-md-4" style="padding: 0;">
                                <div class="btn-group-vertical btn-block">
                                    <p class="btn btn-info btn-block btn-flat payment-btn"
                                        style=";border-radius: 0px;cursor:pointer">Payment</p>
                                </div>
                            </div>
                            <div class="col-xs-4 col-md-4" style="padding: 0;">
                                <div class="btn-group-vertical btn-block">
                                    <button type="button" class="btn btn-success btn-block btn-flat" id="reset"
                                        style=";border-radius: 0px;">Bill</button>
                                </div>
                            </div>
        ...
        <!-Product list start-->
            <div class="col-sm-7 col-md-7 ml-4 rightdiv">
                <div class="product_list pt-3">
                    @foreach ($allProducts as $products)
                        <button class="btn-prni btn-default product pos-tip productItem" title="{{ $products->name }}"
                            data-pro_id="{{ $products->id }}">
                            @if (!empty($products->image))
                                <img src="{{ asset('/') }}{{ $products->image }}" alt="{{ $products->name }}"
                                    class="img-rounded">
                            @else
                                <img src="{{ asset('/') }}public/admin/defaultIcon/no_image.png"
                                    alt="{{ $products->name }}" class="img-rounded">
                            @endif
            ...
            <div id="category_area">
                @foreach ($categories as $category)
                    <button class="btn-prni btn-default product pos-tip category_btn" title="{{ $category->name }}"
                        data-cat_id="{{ $category->id }}">
                        <img src="{{ asset('/') }}public/admin/defaultIcon/no_image.png" alt="acifix 250mg"
                            class="img-rounded">
            ...
            <div id="subcategory_area">
                @foreach ($subcategories as $subcat)
                    <button class="btn-prni btn-default product pos-tip subcategoty_btn" title="{{ $subcat->name }}"
                        data-subcat_id="{{ $subcat->id }}">
                        <img src="{{ asset('/') }}public/admin/defaultIcon/no_image.png" alt="acifix 250mg"
                            class="img-rounded">
            ...
            <div id="brands_area">
                @foreach ($brands as $brand)
                    <button class="btn-prni btn-default product pos-tip brand_btn" title="{{ $brand->name }}"
            ...
            <div
                style="float: right;right:0px;min-height:500px;min-width: 40px;margin-right: 0px;position: fixed;margin-top:50px;">
    ...
    <!--Customer Modal -->
    <div class="modal fade bd-example-modal-lg customer_modal" tabindex="-1" role="dialog" aria-labelledby="customer_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-3">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" value="Add Customer" id="saveCustomer"
    ...
    <div class="modal fade bd-example-modal-lg customer_details_modal" tabindex="-1" role="dialog"
        aria-labelledby="customer_details_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-3">
                <div class="modal-header">
    ...
    <!--Product modal-->
    <div class="modal fade bd-example-modal-lg product_modal" tabindex="-1" role="dialog" aria-labelledby="product_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-3">
                <div class="modal-header">
    ...
    <!--Discount modal-->
    <div class="modal fade bd-example-modal-lg discount_modal" tabindex="-1" role="dialog" aria-labelledby="discount_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content p-3">
                <div class="modal-header">
    ...
    <!--Payment modal-->
    <div class="modal fade bd-example-modal-lg payment_modal" tabindex="-1" role="dialog" aria-labelledby="payment_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-3">
    ...
    <!--Bill modal-->
    <div class="modal fade bd-example-modal-lg bill_modal" tabindex="-1" role="dialog" aria-labelledby="payment_modal"
        aria-hidden="true">
    ...
    <div class="modal fade bd-example-modal-lg product_info" tabindex="-1" role="dialog" aria-labelledby="payment_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content p-3">
                <div class="modal-header">
