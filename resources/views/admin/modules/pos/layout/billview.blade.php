...
@section('posContent')
    <div class="row mt-5">
        <div class="offset-4 col-4 mt-5 p-0">
            <a href="#" class="btn btn-success col-12 " style="color:white;font-size:20px;border-radius: 0px;"
                onclick="printContent('print')">PRINT</a>
            <a href="{{ route('admin.posModule') }}" class="btn btn-info col-12 mt-1"
                style="color:white;font-size:20px;border-radius: 0px;">BACK TO POS</a>
        ...
        <div class="offset-4 col-4 mt-0 p-4 mt-1" style="border:1px dotted gray" id="print">
            ...
            <div style="text-align: center;">
                <p class="bill_p" style="font-size: 12px;font-weight: bold;">Pewered By www.piithub.com</p>
            </div>

        </div>
        <div class="offset-4 col-4 mt-0 mb-5 p-0">

            <a href="{{ route('admin.pos.deleteSale', $billInfo->id) }}" class="btn btn-danger col-12 mt-1"
                style="color:white;font-size:20px;border-radius: 0px;">DELETE</a>
