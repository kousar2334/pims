...
<head>
    ...
    <link rel="icon" href="{{ asset('/') }}public/admin/defaultIcon/logo.png" />
    <!--bootstrap-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="navbar" style="padding:1px;">
        <a class="navbar-brand" style="padding:0px;" href="{{ route('admin.dashboard') }}"> <img
                src="{{ asset('/') }}public/admin/defaultIcon/logo.png" class="img-fluid"
                style="width:170px;height: 50px;" alt="skilldigger"></a>
        <button class="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarcoll">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarcoll" style="padding-top:10px;padding-bottom: 5px;">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu p-0" id="dropdown-background">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.quantityAdjustment') }}">Quantity
                                Adjustment</a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu p-0" id="dropdown-background">
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.system.setting') }}">System Settings</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.subcategory') }}">Subcategories</a>
                        </li>
                        <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu p-0" id="dropdown-background">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.sms.smsSetting') }}">SMS Settings</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.sms.sendSms') }}">Send SMS</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.sms.smsToAll') }}">Send SMS To All
                                Customers</a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu p-0" id="dropdown-background">
                        ...
                        <li>
                            <a href="{{ route('admin.report.expenseReport') }}" class="dropdown-item"
                                href="">Expense
                                Report</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.report.productReport') }}" class="dropdown-item"
                                href="">Product
                                Report</a>
                        </li>
                    </ul>
                ...
                <li class="nav-item dropdown p-1 ml-2" style="background:#ffc107 !important">
                    <a class="nav-link" href="{{ route('admin.stock.lowStockProduct') }}"
                        title="{{ $lowStock }} products are in low stock"><i class="fa fa-exclamation-triangle"
                            style="font-size: 12px"></i><span class="warning-btn">{{ $lowStock }}</span>
