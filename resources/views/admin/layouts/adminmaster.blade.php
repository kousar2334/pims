			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu p-0" id="dropdown-background">
						...
						<li>
							<a class="dropdown-item" href="{{route('admin.sms.smsSetting')}}">SMS Setting</a>
						</li>
						<li>
							<a class="dropdown-item" href="{{route('admin.sms.sendSms')}}">Send SMS</a>
						</li>
						<li>
							<a class="dropdown-item" href="{{route('admin.sms.smsToAll')}}">Send SMS To All Customer</a>
						</li>
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu p-0" id="dropdown-background">
						...
						<li>
							<a href="{{route('admin.report.expenseReport')}}" class="dropdown-item" href="">Expense Report</a>
						</li>
						...
						<li>
							<a href="{{route('admin.report.productReport')}}" class="dropdown-item" href="">Product Report</a>
						</li>
					</ul>			     
				</li>
