...
@section('adminContent')
    ...
    <div class="col-md-12 mt-5 pt-3 border-bottom">
        <div class="text-dark px-0">
            <p class="mb-1"><a href="{{ route('admin.dashboard') }}" class="active-slink"><i
                        class="fa fa-home"></i> Dashboard</a><span class="top-date">{{ date('l, jS F Y') }}</span>
            </p>
        ...
        <div class="row p-1 col-xs-12">
            <div class="col-sm-3">
                <div class="small-box padding1010 borange"
                    style="padding:10px !important;background: #fa603d !important;height:140px;">
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="small-box padding1010 bdarkGreen"
                    style="padding:10px !important;background: #78cd51 !important;height:140px;">
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="small-box padding1010 bpurple"
                    style="padding:10px !important;background: #8e44ad !important;height:140px;">
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="small-box padding1010 bred"
                    style="padding:10px !important;background: #ff5454 !important;height:140px;">
                        ...
                        <div class="offset-md-5 col-6 mt-3">
                            <center>
                                <p class="chart-bottom-lebel"><i class="fa fa-square" style="color:rgb(11, 98, 164);"></i>
                                    Purchase</p>
                                <p class="chart-bottom-lebel"><i class="fa fa-square"
                                        style="color:rgb(122, 146, 163);"></i> Expense</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="row">
                    ...
                    <div class="col-3 col-xs-12 p-2">
                        <center>
                            <a href="{{ route('admin.supplierAdd') }}" class="btn btn-success quick-link">Add
                                Supplier</a>
                        </center>
                    </div>
                    <div class="col-3 col-xs-12 p-2">
                        <center>
                            <a href="{{ route('admin.productAdd') }}" class="btn btn-warning quick-link"
