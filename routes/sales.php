...
//sales return
Route::get('/sales-return/{id}','SalesController@salesReturn')->name('admin.salesReturn');	
Route::get('/sales-return-remove-item/{id}','SalesController@salesReturnRemoveItem')->name('admin.sales.salesReturn.removeItem');
